...
#define PIN_RS485_MODBUS_TE     4

#define PIN_LED_MODBUS_READ     9
#define PIN_LED_MODBUS_WRITE   10

#define PIN_COIL_LED_1         15
#define PIN_COIL_LED_2         14

#define PIN_INDICATION_I2C_SDA  2
#define PIN_INDICATION_I2C_SCL  3

#define PIN_DISCRETE_INPUTS_1   7
#define PIN_DISCRETE_INPUTS_2   8

#define PIN_INPUT_REGISTRY_1   A0
#define PIN_INPUT_REGISTRY_2   A1

#define PIN_HOLDING_REGISTRY_1  5
#define PIN_HOLDING_REGISTRY_2  6
